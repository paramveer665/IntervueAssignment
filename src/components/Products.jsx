...
import Six from '../assets/13.png'
import Seven from '../assets/14.png'
import Eight from '../assets/15.png'
      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
            <img src={Six} alt="Matching Interviewer" className="mb-4 md:h-70 md:w-90 border border-gray-100" />
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
            <img src={Seven} alt="Live interviews" className="mb-4 md:h-70 md:w-100 border border-gray-100 overflow-auto object-cover " />
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
            <img src={Eight} alt="Assessments" className="mb-4 md:h-70 md:w-90 border border-gray-100" />
