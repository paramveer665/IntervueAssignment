      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
            <img src='/src/assets/15.png' alt="Matching Interviewer" className="mb-4 md:h-70 md:w-90 border border-gray-100" />
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
            <img src='/src/assets/14.png' alt="Live interviews" className="mb-4 md:h-70 md:w-100 border border-gray-100 overflow-auto object-cover " />
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
            <img src='/src/assets/13.png' alt="Assessments" className="mb-4 md:h-70 md:w-90 border border-gray-100" />
