    ...
    <section className="bg-white py-20">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="relative w-full md:w-1/2 mx-auto">
          <input type="text" placeholder="Search for resource here" className="w-full px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200 pl-10" />
